...
const LOCATION_STATUSES = ["ACTIVE", "INACTIVE", "ARCHIVED"] as const;
...
type FormValues = z.infer<typeof editLocationSchema>;
...
export function EditLocationForm({
  ...
  async function onSubmit(values: FormValues) {
    ...
    const body: components["schemas"]["UpdateLocationDto"] = {
      name: values.name,
    ...
    const { data, error, response } = await apiClient.PATCH("/locations/{id}", {
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full overflow-y-auto sm:max-w-md">
        <SheetHeader className="pb-4">
          <SheetTitle className="text-xl">Edit Location</SheetTitle>
          <SheetDescription>
            Update this location’s operational details.
          </SheetDescription>
        </SheetHeader>
